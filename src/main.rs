...
async fn main() -> eyre::Result<()> {
    ...
    let token_in = H160::from_str("0x3e61c7fB137765E7CfCC4399d2D7D5Bc1838D6b1").unwrap();
    let token_out = H160::from_str("0x40c9393D4E7153199fB28615A2A0A7039AE1Df15").unwrap();
